    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            required
            className="w-full p-3 border border-gray-400 rounded-lg text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#133E87]"
          />
        </div>
        ...
        <a href="/forgot-password" className="text-sm text-[#133E87] hover:underline block">
          Mot de passe oublié ?
        </a>
      ...
      <div className="mt-6 text-center">
        <span className="text-sm text-gray-600">
          ...
          <a href="/signup" className="text-[#133E87] hover:underline">
            S'inscrire
          </a>
        </span>
      </div>
